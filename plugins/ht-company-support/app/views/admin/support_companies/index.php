<div class="wrap">
<h1 class="wp-heading-inline"><?php echo ("Support Company"); ?></h1>
<?php echo '<a href="'.admin_url('admin.php?page=mvc_support_companies-add').'" class="page-title-action">Add New</a>';?>
</div>
