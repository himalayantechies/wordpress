<!-- <h2>Add Support Group</h2>
 -->
<?php $current_user = wp_get_current_user();
$group_owner = $current_user->user_login; ?>
...
<?php echo $this->form->hidden_input('group_owner', $options = array('value' => $group_owner)); ?>
<!-- <div>
<label>Company Users</label>
for()
<input type="checkbox" value="$comp[id'" name="data[SupportGroup][SupportCompuser][ids][]">comp[name]</input>
}
</div> -->
