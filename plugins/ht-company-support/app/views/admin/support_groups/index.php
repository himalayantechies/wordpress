<div class="wrap">
<h1 class="wp-heading-inline"><?php echo MvcInflector::pluralize_titleize($model->name); ?></h1>
<?php echo '<a href="'.admin_url('admin.php?page=mvc_support_groups-add').'" class="page-title-action">Add New</a>';?>
</div>
...
<table class="widefat post fixed striped" cellspacing="0">
    ...
    <thead>
        <?php echo $this->group->admin_header_cells($this); ?>
    </thead>
    ...
    <tbody>
        ...
        <?php echo $this->group->admin_table_cells($this, $objects ); ?>
    </tbody>
