<div class="wrap">
<h1 class="wp-heading-inline"><?php echo ("Support Users"); ?></h1>
<?php echo '<a href="'.admin_url('admin.php?page=mvc_support_compusers-add').'" class="page-title-action">Add New</a>';?>
</div>
