...
<?php echo '<a href="'.admin_url('admin.php?page=mvc_support_tasks-add').'" class="page-title-action">Add New</a>';?>
</div>
...
<table class="widefat post fixed striped" cellspacing="0">
    ...
    <thead>
        <?php echo $this->task->admin_header_cells($this); ?>
    </thead>
    ...
    <tbody>
        <?php echo $this->task->admin_table_cells($this, $objects); ?>
    </tbody>
