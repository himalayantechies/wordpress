     ...
     <style>
        ...
        <div class="bup-staff ">
             ...
             <?php if($avatar==''){?>	
                ...
                <div class="camp-type" id="bup-camp-type">
                    <div class="bup-camp-type-add">
                        <span class="SpanHeading">Add Camp  Types</span>
                        <span class="bup-add-camp-type">
                            <a href="#" id="ubp-add-camp-type-btn" title="Add New Camp Type">
                                <i class="fa fa-plus"></i>
                            </a>
                        </span>
                    </div>
                 </div>
                 <div class = "bup-camp-type-add"></div>
