...
class BookingUltraTrainingsessions
{
	...
	public function bup_update_staff_admin()
	{
		...
		$reg_emergency_contact = $_POST['reg_emergency_contact'];
		$reg_dbs_number = $_POST['reg_dbs_number'];
		$reg_safeguarding_expiry = $_POST['reg_safeguarding_expiry'];
		$reg_expiry_firstaid_date = $_POST['reg_expiry_firstaid_date'];
		$reg_rating = $_POST['reg_rating'];
		...
		{			
			...
			if($staff_id)
			{
				...
				update_user_meta ($staff_id, 'reg_emergency_contact',$reg_emergency_contact);
				update_user_meta ($staff_id, 'reg_dbs_number',$reg_dbs_number);
				update_user_meta ($staff_id, 'reg_safeguarding_expiry',$reg_safeguarding_expiry);
				update_user_meta ($staff_id, 'reg_expiry_firstaid_date',$reg_expiry_firstaid_date);
				update_user_meta ($staff_id, 'reg_rating',$reg_rating);
				update_user_meta ($staff_id, 'reg_location',$reg_location);
	...
	//	$html .='<div class="bup-field-value" ><input type="text" class=" bup-input " name="display_name" id="reg_display_name" value="'.$user->display_name.'" title="'.__('Your Full Name','bookingup').'" ></div>';		
		...
		$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="display_name"><span>'.__('Emergency Contact number','bookingup').'</span></label>';
                $html .='<div class="bup-field-value" ><input type="text" class=" bup-input " name="reg_emergency_contact" id="reg_emergency_contact" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_emergency_contact').'" title="'.__('Emergency Contact number','bookingup').'" ></div>';
                $html .= '</div>';

		$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="display_name"><span>'.__('DBS Number','bookingup').'</span></label>';
                $html .='<div class="bup-field-value" ><input type="text" class=" bup-input " name="reg_dbs_number" id="reg_dbs_number" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_dbs_number').'" title="'.__('DBS Number','bookingup').'" ></div>';
                $html .= '</div>';
	
		$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="display_name"><span>'.__('Safeguarding expiry date','bookingup').'</span></label>';
                $html .='<div class="bup-field-value" ><input type="date" class="bupro-datepicker hasDatepicker" name="reg_safeguarding_expiry" id="reg_safeguarding_expiry" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_safeguarding_expiry').'" title="'.__('Safeguarding expiry date','bookingup').'" ></div>';
                $html .= '</div>';

    	 	$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="display_name"><span>'.__('Expiry date for First Aid','bookingup').'</span></label>';
                $html .='<div class="bup-field-value" ><input type="date" class=" bup-input " name="reg_expiry_firstaid_date" id="reg_expiry_firstaid_date" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_expiry_firstaid_date').'" title="'.__('Expiry date for First Aid','bookingup').'" ></div>';
                $html .= '</div>';
	 
		$reg_ratingAnswer = $bookingultrapro->bup_get_user_meta($staff_id, 'reg_rating');			
		$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="reg_rating"><span>'.__('Rating','bookingup').'</span></label>';

		$html .='<div class="bup-field-value" >
                <select class=" bup-input " name="reg_rating" id="reg_rating" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_rating').'" title="'.__('Rating','bookingup').'">
                        <option > -select- </option>
                        <option value = "1"';
                        if($reg_ratingAnswer == 1){
                                $html.= 'selected="selected"';
                        }
                        $html.='> 1 </option>';
                        $html.= '<option value = "2"';
						if($reg_ratingAnswer == 2){
                                $html.= 'selected="selected"';
                        }
                        $html.='> 2 </option>
                        <option value = "3"';
						if($reg_ratingAnswer == 3){
                                $html.= 'selected="selected"';
                        }
                        $html.='> 3 </option>
                        <option value = "4"';
						if($reg_ratingAnswer == 4){
                                $html.= 'selected="selected"';
                        }
                        $html.='> 4 </option>
                        <option value = "5"';
						if($reg_ratingAnswer == 5){
                                $html.= 'selected="selected"';
                        }
                        $html.='> 5 </option>
		...
		$html .='<div class="bup-profile-field" >';
                $html .='<label class="bup-field-type" for="reg_location"><span>'.__('Location','bookingup').'</span></label>';
                $html .='<div class="bup-field-value" ><input type="text" class=" bup-input " name="reg_location" id="reg_location" value="'.$bookingultrapro->bup_get_user_meta($staff_id, 'reg_location').'" title="'.__('Location','bookingup').'" ></div>';
                $html .= '</div>';
	...
	function get_staff_list_calendar_filter( $service_id=null )
	{
		...
		$htm .= '<option value="" selected="selected" >'.__('Coach', 'bookingup').'</option>';
