    ...
    class cs_employer_ajax_templates {
        ...
        public function cs_employer_ajax_profile($uid = '') {
            ...
            if ( $uid != '' ) {
                ...
                <?php if ( $cs_comp_name != '' ) { ?>
                    <h3 class="cs-candidate-title"><?php printf(esc_html__('Welcome %s', 'jobhunt'), esc_html($cs_comp_name)) ?></h3>
                <?php } ?>
                        ...
                        <div class="cs-account-info">
                            <div class="cs-img-detail">
                                ...
                                <div class="upload-btn-div">
                                    ...
                                    <br />
                                    <span id="cs_employer_profile_img_msg"><?php esc_html_e('Max file size is 1MB, Minimum dimension: 270x210 And Suitable files are .jpg & .png', 'jobhunt') ?></span>
                                </div>
                            </div>
                            <div class="cs-img-detail">
                                <div class="alert alert-dismissible user-img"> 
                                ...
                                <div class="upload-btn-div">
                                    ...
                                    <br /> 
                                    <span id="cs_employer_profile_cover_msg"><?php esc_html_e('Max file size is 1MB, Minimum dimension: 1600x400 And Suitable files are .jpg & .png', 'jobhunt') ?></span>
                                </div>
                            </div>
                        ...
                        <div class="cs-contact-info">
                            ...
                            <div class="input-info">
                                <div class="row">
                                    ...
                                    <?php do_action('jobhunt_frontend_location_fields', $uid, 'employer_profile', $current_user); ?>
                                </div>
                            </div>
                        </div>
                        <?php
                    ...
                    if ( $custom_query->have_posts() ) {
                        ...
                        <ul class="dashboard-list">
                            ...
                            <?php if ( $candidate_enable == true && $remove_candidate_role != 'yes' ) { ?>
                                <li><span><span><?php echo absint($cs_emp_funs->all_jobs_apps($uid)) ?></span><em><?php esc_html_e('Applications', 'jobhunt'); ?></em></span><i class="icon-newspaper4"></i></li>
                            <?php } else { ?>
                                <li>&nbsp;</li>
                            <?php } ?>
