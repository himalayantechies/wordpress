...
//            );
        ...
        $jobcareer_sett_options[] = array(
            ...
            'classes' => 'chosen-select-no-single',
            "type" => "select_values",
            "options" => array('default-footer' => esc_html__("Default Footer", 'jobcareer'), 'fancy-footer' => esc_html__("Fancy Footer", 'jobcareer'), 'modern-footer' => esc_html__("Modern Footer", 'jobcareer'), 'modern-footer2' => esc_html__("Modern Footer 2", 'jobcareer')),
        );
